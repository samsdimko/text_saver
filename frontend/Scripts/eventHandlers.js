...
import { fetchSavedTexts, getUserTags, saveText, deleteText, deleteTag, saveTag } from './api.js';
...
function handleSaveTagButtonClick() {
...
function openTagConstructor() {
  ...
  // Add a CSS class to adjust the positioning of the modal
